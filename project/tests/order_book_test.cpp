...
TEST(OrderBookTest, AddOrder) {
    OrderBook order_book(10);

    Order* o1 = order_book.addOrder(1, 101, "AAPL", 100, 15000, true, OrderType::Limit);
    ASSERT_NE(o1, nullptr);
    EXPECT_EQ(o1->order_id, 1u);
    EXPECT_EQ(o1->price, 15000u);
    EXPECT_TRUE(o1->is_buy_side);

    Order* o2 = order_book.addOrder(2, 102, "AAPL", 50, 15000, true, OrderType::Limit);
...
TEST(OrderBookTest, RemoveOrder) {
    ...
    Order* o1 = order_book.addOrder(1, 101, "AAPL", 100, 15000, true, OrderType::Limit);
    Order* o2 = order_book.addOrder(2, 101, "AAPL", 100, 15000, true, OrderType::Limit);
    Order* o3 = order_book.addOrder(3, 101, "AAPL", 100, 15000, true, OrderType::Limit);

    auto& buy_levels = order_book.getBuyLevels();
    ASSERT_EQ(buy_levels.at(15000).size(), 3u);

    // Remove middle
    order_book.removeOrder(o2);
    EXPECT_EQ(buy_levels.at(15000).size(), 2u);
    EXPECT_EQ(o1->list_node.next, o3);
    EXPECT_EQ(o3->list_node.prev, o1);

    // Remove head
    order_book.removeOrder(o1);
    EXPECT_EQ(buy_levels.at(15000).size(), 1u);
    EXPECT_EQ(buy_levels.at(15000).head(), o3);
    EXPECT_EQ(o3->list_node.prev, nullptr);

    // Remove last
    order_book.removeOrder(o3);
    EXPECT_EQ(buy_levels.count(15000), 0u);
}

TEST(OrderBookTest, SellSide) {
    OrderBook order_book(10);

    Order* o1 = order_book.addOrder(1, 101, "AAPL", 100, 15100, false, OrderType::Limit);
    ASSERT_NE(o1, nullptr);
...
TEST(OrderBookTest, PoolExhaustion) {
    ...
    Order* o2 = order_book.addOrder(2, 102, "AAPL", 100, 15000, true, OrderType::Limit);
